    ...
    public partial class add1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "EvId", "EvDate", "EvDescription", "EvShortDescription", "EvType" },
                values: new object[] { 1, new DateTime(2023, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "First Event", "Event Title", "Golf Round" });
            ...
            migrationBuilder.InsertData(
                table: "Members",
                columns: new[] { "MemberId", "Email", "EmailConfirmed", "FirstName", "FullName", "Handicap", "LastName", "MemberStatus", "MemberTee", "MemberType", "PhoneNumber", "PreferredNotification" },
                values: new object[,]
                {
                    { 1, "willffdunn@gmail.com", false, "William", "WilliamDunn", 9, "Dunn", "Active", "White", "TBRes", "484-885-7000", "Both" },
                    { 2, "karenfdunn@gmail.com", false, "Karen", "KarenDunn", 19, "Dunn", "Active", "Red", "TBRes", "610-733-38380", "Both" }
                });
            ...
            migrationBuilder.InsertData(
                table: "GolfRounds",
                columns: new[] { "GRId", "GCId", "GRDate", "GRType" },
                values: new object[] { 1, 1, new DateTime(2023, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "TBGC Club, Stroke Play" });
